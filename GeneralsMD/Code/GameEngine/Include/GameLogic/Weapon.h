...
Bool FireWeaponAndHandleOCL(Weapon *weapon, Object *source, Object *target, ObjectID* projectileID = nullptr);
Bool FireWeaponAndHandleOCL(Weapon *weapon, Object *source, const Coord3D* pos, ObjectID* projectileID = nullptr);
...
//~Weapon();
	...
	Bool fireWeapon(Object *source, Object *target, ObjectID* projectileID = nullptr);

	// return true if we auto-reloaded our clip after firing.
	Bool fireWeapon(Object *source, const Coord3D* pos, ObjectID* projectileID = nullptr);
