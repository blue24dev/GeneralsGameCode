...
// Only relevant in debug mode, these messages are already guaranteed excluded in release builds.
// However, see the alternative, 'MSG_CHEAT_...' messages, reached by key inputs described in 'CommandMapDemo.ini'.
// These messages are only handled in release builds that have '_ALLOW_DEBUG_CHEATS_IN_RELEASE'.
...
// ---
// This setting changes retail behavior so that shroud generated by active shrouders (AKA jammers) isn't persistent.
...
// because of this.
// When this setting is on, all models are precached for both day/night variants - under several mods, the game can
...
#define FORCE_GAME_CONTEXT FGC_GENERALS_NONE
#define DEFAULT_GLOBAL_SKIRMISH_DIFFICULTY DIFFICULTY_HARD
#define FORCE_HUMAN_PLAYER_START_MONEY 0
#define BLOCK_SET_MONEY_SCRIPT_FOR_HUMAN_PLAYERS TRUE

#define COMPUTER_PLAYER_MONEY_SCALAR 3.00
#define COMPUTER_PLAYER_EXPERIENCE_SCALAR 1.25
#define REMOVE_FOG_OF_WAR FALSE
