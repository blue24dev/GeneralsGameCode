...
Real W3DView::getMaxHeight(Real x, Real y) const
{
	...
	return m_pos.z + getMaxHeightAboveGround();
}
...
void W3DView::updateCameraClipPlanes(const Matrix3D &transform)
{
	...
	else
	{
		...
		// ------------------------------
		// Way with 'getZoomOld()' to resemble retail's original check if I remember correctly, as well as the
		// 'TheGlobalData->m_drawEntireTerrain' that's also since been removed by 'TheSuperHackers':
		// ---
